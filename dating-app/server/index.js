...
app.get("/usersData", async (req, res) => {
  try {
    const allData = await UserModel.find(); // Fetch all data from the MongoDB collection
    console.log(allData);
    res.json(allData);
  } catch (err) {
...
// GET Method to display accepted people chats
// app.get('/userChats/:userId',async (req,res)=>{
//     const {userId}=req.params;
//     // const userData=await getUserDataFromRequest(req);
//     // const ourUserId=userData.userId;
//     const OurData = await User.findOne({userId});
//     if(OurData.accepted!=null){
//         res.json(OurData.accepted);
//     }
// });

app.post("/sendRequest", async (req, res) => {
  const [myId, reqId] = req.body; // Access the posted data from the request body
  // Handle the received data (e.g., save it to a database)
  console.log("Recepient id:", reqId);
