...
export default function SlidingImages() {
              ...
              <div key={user._id}>
                ...
                <div className="flex justify-center items-center">
                  <button
                    ...
                    className="bg-purple-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded mt-3"
                  >
                    Send Request
                  </button>
                </div>
  ...
  //   return (
  //     <div>
  //       <div className="h-20 w-full bg-gray-500">hi</div>
  //       <div className="max-w-screen-lg mx-auto">
  //         <Slider ref={sliderRef} {...settings}>
  //           <div>
  ...
  //           </div>
  //           <div>
  //             <div style={boxStyle}>Box 9</div>
  //           </div>
  //           <div>
  //             <div style={boxStyle}>Box 10</div>
  //           </div>
  //           <div>
  //             <div style={boxStyle}>Box 11</div>
  //           </div>
  //         </Slider>
